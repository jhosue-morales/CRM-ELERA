...
<body>
    <style>
        * { box-sizing: border-box; }
        ...
        .form-control::placeholder { color: #a8b1bd; }
            ...
            <div class="form-content">
                ...
                <form method="POST" id="formCliente">
                                ...
                                <div class="input-group">
                                    <select name="tipo" class="form-select" required>
                                        <?php foreach ($tipos as $t): ?>
                                            <option value="<?php echo htmlspecialchars($t['nombre']); ?>"><?php echo htmlspecialchars($t['nombre']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                    ...
                    <div class="form-footer">
                        ...
                        <button type="submit" class="btn-save"><i class="bi bi-check-lg me-1"></i> Guardar cliente</button>
                    </div>
                </form>
            </div>
        </div>
