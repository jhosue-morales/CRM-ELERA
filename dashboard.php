...
====================================== -->
    <aside id="sidebar" class="sidebar">
        ...
        <nav class="menu">
            <a href="reportes.php" class="menu-item" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Reportes"><i class="bi bi-bar-chart"></i><span>Reportes</span></a></a>
