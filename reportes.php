...
<a href="reporte_actividad.php" class="btn btn-secondary">
    <i class="bi bi-person-check me-1"></i> Reporte de Actividad
</a>
<a href="reporte_tendencias.php" class="btn btn-dark">
